...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            <form class="form-horizontal" action="{{route('vne.coursetemplate.edit', ['course_template_id' => $courseTemplate->course_template_id])}}" method="post" id="form-add-template-course">
                ...
                <fieldset>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="template_name" name="template_name" type="text" value="{{old('template_name', isset($courseTemplate) ? $courseTemplate->template_name : '')}}" class="form-control"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control resize_vertical" id="target" name="target" placeholder="Nhập mục tiêu khóa học..." rows="5">
                                    {{old('target', isset($courseTemplate) ? $courseTemplate->target : '')}}
                                </textarea>
                            </div>
                        </div>
                        <!-- Message body -->
