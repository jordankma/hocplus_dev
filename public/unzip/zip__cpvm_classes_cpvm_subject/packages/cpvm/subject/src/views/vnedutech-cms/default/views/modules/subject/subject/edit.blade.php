...
{{-- Page title --}}
@section('title'){{ $title = trans('cpvm-subject::language.titles.subject.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form action="{{ route('cpvm.subject.subject.update') }}" method="post" class="bf" id="form-add-subject">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" value="{{$subject->name}}" class="form-control" placeholder="{{trans('cpvm-subject::language.placeholder.subject.name')}}">
                            </div>
                            <label>{{trans('cpvm-subject::language.label.subject.background_color')}}<span style="color: red">(*)</span></label>
                            <div class="form-group">
                                <input id="mycp1" type="text" name="background_color" value="{{$subject->background_color}}" class="form-control colorpicker-element" placeholder="{{trans('cpvm-subject::language.placeholder.subject.background_color')}}">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                   ...
                                   <input type="text" name="icon" value="{{$subject->icon}}" id="thumbnail1" class="form-control">
                                 </div>
                                 <img src="{{$subject->icon}}" id="holder1" style="margin-top:15px;max-height:100px;">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <label>{{ trans('cpvm-subject::language.label.subject.priority') }} <span style="color: red">(*)</span></label>
                            <div class="form-group">
                                <input type="number" min="0" name="priority" value="{{$subject->priority}}" class="form-control" placeholder="{{trans('cpvm-subject::language.placeholder.subject.priority')}}">
                            </div>
                            <label>{{trans('cpvm-subject::language.label.subject.background_color_mobile')}}<span style="color: red">(*)</span></label>
                            <div class="form-group">
                                <input id="mycp2" type="text" name="background_color_mobile" value="{{$subject->background_color_mobile}}" class="form-control" placeholder="{{trans('cpvm-subject::language.placeholder.subject.background_color_mobile')}}" autofocus="">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                   ...
                                   <input type="text" name="icon_mobile" value="{{$subject->icon_mobile}}" id="thumbnail2" class="form-control">
                                 </div>
                                 <img src="{{$subject->icon_mobile}}" id="holder2" style="margin-top:15px;max-height:100px;">
                            </div>
                        </div>
                        <!-- /.col-sm-8 -->
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <select id="classes" class="form-control" name="classes[]" required="" multiple="multiple">
                                    ...
                                    @foreach($classes as $cl)
                                        <option value="{{$cl->classes_id}}" @if(in_array($cl->classes_id, $list_class_id)) selected="" @endif>{{$cl->name}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                            <div class="form-group col-xs-12">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success">{{ trans('cpvm-subject::language.buttons.update') }}</button>
