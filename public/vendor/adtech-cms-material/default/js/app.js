...
var __prefix = {
    view: typeof(AdtechApp.group) ? 'vendor/' + AdtechApp.group + '/' + AdtechApp.skin + '/' : ''
};
angular
    .module('AdtechApp', [
        'ngAnimate',
    ...
    .config([
        ...
        function (
            ...
            if (AdtechApp.auth.isLogin == true) {
            ...
            $stateProvider.state({
                name: 'common',
                abstract: true,
                templateUrl: __prefix.view + 'views/common.html',
            ...
            $stateProvider.state({
                name: 'common.home',
                url: '/',
                templateUrl: __prefix.view + 'views/home.html',
                controller: 'HomeCtrl'
            });
            ...
            $stateProvider.state({
                ...
                url: '/item1',
                templateUrl: __prefix.view + 'views/default.html',
