...
angular
    .module("AdtechApp")
    .controller('paymentMailCtrl', paymentMailCtrl);

function paymentMailCtrl($scope, $mdDialog, $http, $mdToast, removeByAttr) {
    $scope.onChangeStatus = function (status, id) {
        $http({
            ...
            if (response.success == true) {
                ...
                $mdToast.show(
                    $mdToast.simple()
                        .textContent('Cập nhật thành công email: ' + response.email)
                        .theme("success-toast")
                        .position('top right')
                        .action('⛌')
                );
                ...
                $scope.addMail = function () {
                    $http({
                        ...
                        if (response.success == true) {
                            ...
                            $mdToast.show(
                                $mdToast.simple()
                                    .textContent('Thêm thành công email: ' + response.email)
                                    .theme("success-toast")
                                    .position('top right')
                                    .action('⛌')
                            );
                        ...
                        $mdDialog.show(confirm).then(function () {
                            $http({
                                ...
                                if (response.success == true) {
                                    ...
                                    $mdToast.show(
                                        $mdToast.simple()
                                            .textContent('Xoá thành công email: ' + response.email)
                                            .theme("success-toast")
                                            .position('top right')
                                            .action('⛌')
                                    );
