...
Route::group(array('prefix' => $adminPrefix), function() {
    ...
    Route::get('khoa-hoc-cua-toi', 'StudentProfileController@wishlist')->middleware('member.auth')->name('hocplus.studentprofile.khoa-hoc-cua-toi');
    Route::any('bang-thong-tin', 'StudentProfileController@myCourse')->middleware('member.auth')->name('hocplus.studentprofile.bang-thong-tin');
