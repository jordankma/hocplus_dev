...
{{-- Page title --}}
@section('title'){{ $title = trans('hocplus-studentprofile::language.titles.demo.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                {!! Form::model($demo, ['url' => route('hocplus.studentprofile.demo.update'), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                <div class="row">
                    <div class="col-sm-8">
