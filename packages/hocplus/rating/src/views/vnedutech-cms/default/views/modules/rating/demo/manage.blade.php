...
{{-- Page title --}}
@section('title'){{ $title = trans('hocplus-rating::language.titles.demo.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('hocplus.rating.demo.create') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> {{ trans('hocplus-rating::language.buttons.create') }}</a>
                    </div>
                </div>
                <br/>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('hocplus-rating::language.table.demo.name') }}</th>
                                <th style="width: 120px">{{ trans('hocplus-rating::language.table.created_at') }}</th>
                                <th style="width: 120px">{{ trans('hocplus-rating::language.table.updated_at') }}</th>
                                <th>{{ trans('hocplus-rating::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('hocplus.rating.demo.data') }}',
                columns: [
