...
{{-- Page title --}}
@section('title'){{ $title = trans('hocplus-rating::language.titles.demo.create') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => route('hocplus.rating.demo.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'demoForm', 'files'=> true)) !!}
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <div class="row">
                    <div class="col-sm-8">
                        <label>Demo Name</label>
                        <div class="form-group {{ $errors->first('name', 'has-error') }}">
                            {!! Form::text('name', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('hocplus-rating::language.placeholder.demo.name_here'))) !!}
                    ...
                    <div class="col-sm-4">
                        <div class="form-group col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{!! route('hocplus.rating.demo.create') !!}"
                                   class="btn btn-danger">{{ trans('hocplus-rating::language.buttons.discard') }}</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.col-sm-4 -->
