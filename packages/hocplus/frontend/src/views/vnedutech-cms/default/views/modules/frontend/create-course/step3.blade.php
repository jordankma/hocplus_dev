                            ...
                            <div class="detail-wrapper">
                                ...
                                <div class="info">
                                    <ul class="row list">
                                        ...
                                        <li class="col-6 item"><i class="fa fa-clock"></i> Thời lượng mỗi buổi: <input class="fix-content" name="courseTime" type="text" value="{{ $course->time }}" style="text-align: right; width: 20px" required> phút</li>
