                    ...
                    <tr>
                      ...
                      <td>
                        <div
                          ...
                          <div>Thiết lập lại mật khẩu tài khoản của bạn
                          </div>
                        </div>
                        <div
                          ...
                          <div style="padding: 0 30px">
                            <div style="margin-bottom: 5px;">Xin chào <b>{{$toName}}</b></div>
                            Bạn vừa yêu cầu cấp lại mật khẩu mới. Bạn nhận được email này vì chúng tôi muốn đảm bảo rằng đó chính là bạn.<div style="padding-top:24px;text-align:center"><a
                                  ...
                                  <tr>
                                    <td style="padding-left:8px;padding-right:8px;text-align:center">
                                      <a href="{{$resetPasswordLink}}"
                                         ...
                                         target="_blank">THIẾT LẬP LẠI MẬT KHẨU</a></td>
                                  </tr>
                                  <tr style="height:6px"></tr>
                                  </tbody>
                                </table>
