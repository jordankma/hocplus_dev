...
{{-- Page title --}}
@section('title'){{ $title = trans('ptest-mtest::language.titles.demo.create') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => route('ptest.mtest.demo.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'demoForm', 'files'=> true)) !!}
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <div class="row">
                    <div class="col-sm-8">
                        <label>Demo Name</label>
                        <div class="form-group {{ $errors->first('name', 'has-error') }}">
                            {!! Form::text('name', null, array('class' => 'form-control', 'autofocus'=>'autofocus','placeholder'=> trans('ptest-mtest::language.placeholder.demo.name_here'))) !!}
                    ...
                    <div class="col-sm-4">
                        <div class="form-group col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{!! route('ptest.mtest.demo.create') !!}"
                                   class="btn btn-danger">{{ trans('ptest-mtest::language.buttons.discard') }}</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.col-sm-4 -->
