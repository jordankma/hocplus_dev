...
@section('title', __('afp-core::titles.page.forgot_password'))
@section('content')
    <div layout="column" layout-align="center center" class="container-login">
        ...
        <div class="message">
            <h2>{{ __('afp-core::labels.forgot_having_trouble') }}</h2>
            <h4>{{ __('afp-core::labels.forgot_provide_information') }}</h4>
        </div>
                ...
                <md-content class="md-padding md-no-momentum">
                    ...
                    <div layout="row" layout-align="center center">
                        ...
                        <md-button type="submit"
                                   class="md-raised md-primary">{{ __('afp-core::buttons.reset_password') }}</md-button>
                    </div>
                </md-content>
            </div>
        </form>
