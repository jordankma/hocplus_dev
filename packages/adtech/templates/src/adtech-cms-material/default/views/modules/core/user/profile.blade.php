...
<script src="{{ asset('vendor/adtech-cms-material/default/js/services.js?t=' . time()) }}"></script>
<script src="{{ asset('vendor/adtech-cms-material/default/js/user.js?t=' . time()) }}"></script>
@endpush