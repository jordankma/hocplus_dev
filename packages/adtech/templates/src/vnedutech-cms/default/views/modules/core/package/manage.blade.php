                ...
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="{{ route('adtech.core.package.create', ['id' => $domain_id]) }}" class="btn btn-sm btn-default">
                            <span class="glyphicon glyphicon-plus"></span> {{ trans('adtech-core::buttons.create') }}
                        </a>
                    </div>
                </div>
                <br/>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="table">
                            <thead>
                            <tr class="filters">
                                {{--<th>{{ trans('adtech-core::common.detail') }}</th>--}}
                                ...
                                <th>{{ trans('adtech-core::common.package.status') }}</th>
                                <th>{{ trans('adtech-core::common.created_at') }}</th>
                                <th>{{ trans('adtech-core::common.update_at') }}</th>
...
{{--    <script type="text/javascript" src="{{ asset('/vendor/' . $group_name . '/' . $skin . '/vendors/datatables/js/handlebars.js') }}"></script>--}}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h4>Module</h4>
                            <p>
                                <select class="form-control select2" id="select_module"></select>
                            </p>
                        </div>
                    </div>
                </div>
