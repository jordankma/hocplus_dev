...
namespace Adtech\Application\Cms\Repositories\Console\Commands\Creators;
 ...
 *
 * @package Adtech\Application\Cms\Repositories\Console\Commands\Creators
 */
class RepositoryCreator
{
     ...
     * @return int
     */
    public function create($repository, $model, $module)
    {
        // Set the repository.
    ...
    protected function getDirectory()
    {
        ...
        $module = 'module-' . strtolower($this->getModule());
        $directory = 'app' . DIRECTORY_SEPARATOR . 'Modules' . DIRECTORY_SEPARATOR . $module . DIRECTORY_SEPARATOR . $directory;
    ...
    protected function getPopulateData()
    {
        ...
        $repository_namespace = str_replace('[MODULE_NAME]', $module_name, $repository_namespace);
