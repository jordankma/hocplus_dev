...
namespace Adtech\Application\Cms\Repositories\Console\Commands;
 ...
 *
 * @package Adtech\Application\Cms\Repositories\Console\Commands
 */
class MakeRepositoryCommand extends Command
{
    ...
    protected function writeRepository($arguments, $options)
    {
        ...
        if ($this->creator->create($repository, $model, $module)) {
            // Information message.
