...
{{-- Page title --}}
@section('title'){{ $title = trans('adtech-core::titles.locale.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                {!! Form::model($locale, ['url' => route('adtech.core.locale.update'), 'method' => 'put', 'class' => 'bf', 'files'=> true]) !!}
                <div class="row">
                    <div class="col-sm-8">
                        <label>Locale Name</label>
                        <div class="form-group {{ $errors->first('name', 'has-error') }}">
                            {!! Form::text('name', null, array('class' => 'form-control', 'autofocus'=>'autofocus', 'placeholder'=>trans('adtech-core::common.locale.name_here'))) !!}
                            <span class="help-block">{{ $errors->first('name', ':message') }}</span>
                        </div>

                        <label>Locale Alias</label>
                        ...
                        <div class="form-group">
                            {!! Form::checkbox('status', null, ($locale->status == 1) ? true : false, array('data-size'=> 'mini')) !!}
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{!! route('adtech.core.locale.create') !!}"
