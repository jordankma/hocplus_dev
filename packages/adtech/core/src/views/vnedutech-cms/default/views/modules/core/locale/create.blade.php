...
{{-- Page title --}}
@section('title'){{ $title = trans('adtech-core::titles.locale.create') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => route('adtech.core.locale.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'localeForm', 'files'=> true)) !!}
