                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row">
                                ...
                                <form>
                                    ...
                                    <label class="radio-inline">
                                        <input type="radio" class="custom-radio" name="radioAge[]" id="radio_two"
                                               value="49" dusk="radio12">&nbsp;Below 50</label>
                                    <label class="radio-inline">
                            ...
                            <div class="panel panel-primary filterable">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" class="custom-radio2" name="radioAge[]"
                                                   id="custom_radio_two" value="49" dusk="radio22">&nbsp;Below
                                            50</label>
                                        <label class="radio-inline">
