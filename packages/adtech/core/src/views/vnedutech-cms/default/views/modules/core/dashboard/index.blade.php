...
@section('header_styles')
    ...
    <link href="{{ asset('/vendor/' . $group_name . '/' . $skin . '/vendors/animate/animate.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('/vendor/' . $group_name . '/' . $skin . '/css/pages/only_dashboard.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('/vendor/' . $group_name . '/' . $skin . '/css/pages/only_dashboard.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('/vendor/' . $group_name . '/' . $skin . '/css/pages/dashboard2.css') }}" rel="stylesheet" type="text/css">
@stop
...
@section('footer_scripts')
    ...
    <script src="{{ asset('/vendor/' . $group_name . '/' . $skin . '/vendors/moment/js/moment.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/vendor/' . $group_name . '/' . $skin . '/vendors/countUp_js/js/countUp.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/vendor/' . $group_name . '/' . $skin . '/vendors/morrisjs/morris.min.js') }}" type="text/javascript"></script>
