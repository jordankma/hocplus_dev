...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-statistical::language.titles.demo.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('vne.statistical.demo.create') }}" class="btn btn-sm btn-default"><span
                                    class="glyphicon glyphicon-plus"></span> {{ trans('vne-statistical::language.buttons.create') }}</a>
                    </div>
                </div>
                <br/>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th>{{ trans('vne-statistical::language.table.demo.name') }}</th>
                                <th style="width: 120px">{{ trans('vne-statistical::language.table.created_at') }}</th>
                                <th style="width: 120px">{{ trans('vne-statistical::language.table.updated_at') }}</th>
                                <th>{{ trans('vne-statistical::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.statistical.demo.data') }}',
                columns: [
