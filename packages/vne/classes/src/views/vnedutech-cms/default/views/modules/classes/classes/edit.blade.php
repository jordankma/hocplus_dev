...
{{-- Page title --}}
@section('title'){{ $title = trans('cpvm-classes::language.titles.classes.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form action="{{ route('cpvm.classes.classes.update') }}" method="post" class="bf" id="form-add-classes">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" value="{{ $classes->name }}" placeholder="{{trans('cpvm-classes::language.placeholder.classes.name')}}">
                            </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="number" name="priority" class="form-control" value="{{ $classes->priority }}" min="0" placeholder="{{trans('cpvm-classes::language.placeholder.classes.priority')}}">
                            </div>
                            <label>{{trans('cpvm-classes::language.label.classes.color_mobile')}}</label>
                            <div class="form-group">
                                <input id="mycp" type="text" name="color_mobile" value="{{ $classes->color_mobile }}" class="form-control" placeholder="{{trans('cpvm-classes::language.placeholder.classes.color_mobile')}}" autofocus="">
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group col-xs-12">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success">{{ trans('cpvm-classes::language.buttons.update') }}</button>
