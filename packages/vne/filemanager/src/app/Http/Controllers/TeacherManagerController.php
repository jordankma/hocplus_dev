...
namespace Vne\Filemanager\App\Http\Controllers;

use Illuminate\Http\Request;
use Adtech\Application\Cms\Controllers\Controller as Controller;
use Vne\Filemanager\App\Requests\RequestValidator;
use Vne\Filemanager\App\FileManager;
use Vne\Filemanager\App\Services\Zip;
use Validator;
use Auth;
...
class TeacherManagerController extends Controller
{
    ...
    public function __construct(FileManager $fm)
    {
        ...
        config(['filesystems.disks.static.root' => 'public/files/hocplus/teacher/' . $teacher_id]);
    }
    ...
    public function selectDisk(RequestValidator $request)
    {
        return response()->json([
            'result' => [
                'status'  => 'success',
                'message' => trans('VNE-FILEMANAGER::response.diskSelected'),
            ],
        ]);
    }
    ...
    {
        return view('VNE-FILEMANAGER::modules.filemanager.ckeditor');
    }
    public function manage()
    {
        return view('VNE-FILEMANAGER::modules.filemanager.manage');
    }
}