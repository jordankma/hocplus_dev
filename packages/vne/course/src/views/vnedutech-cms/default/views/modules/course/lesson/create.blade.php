...
{{-- Page title --}}
@section('title'){{ $title = 'Tạo buổi học' }}@stop
...
<section class="content paddingleft_right15">
    ...
    <div class="row">
        <div class="the-box no-border">
            <form class="form-horizontal" action="{{route('vne.lesson.add')}}" method="post" id="form-add-template-course">
                ...
                <fieldset >
                    <div id="load_content_lesson">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" name="name[1]" type="text" placeholder="Nhập tên buổi học..." class="form-control">
                            </div>
                        </div>
                        <div class="form-group" >
                            <label class="col-md-2 control-label" for="name">Ngày bắt đầu</label>
                            <div class="col-md-6">
                                <input  name="date_start[1]" type="text" value="" class="date_start form-control">
                            </div>
                        </div>
                        <div class="form-group" >
...
$('body').on('click', '.add-lesson', function () {
    ...
    let html = `<div class="col-md-12 lesson_item">
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="name">Tên buổi học</label>
                        <div class="col-md-6">
                            <input id="name" name="name[${lesson_item + 1}]" type="text" placeholder="Nhập tên buổi học..." class="form-control">
                        </div>
                     ...
                     <div class="form-group" >
                        <label class="col-md-2 control-label" for="name">Ngày bắt đầu</label>
                        <div class="col-md-6">
                            <input  name="date_start[${lesson_item + 1}]" type="text" value="" class="date_start form-control">
                        </div>
                    </div>
                    <div class="form-group" >
                        <label class="col-md-2 control-label" for="name">Thời lượng buổi học</label>
...
$('body').on('click', '.btn-save-lesson', function(e){
    ...
    $('input[name^="ordinal"]').each(function() {
        if(!$(this).val()){
             error = true;
             $(this).css('border-color','red');
        }         
