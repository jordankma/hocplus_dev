    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form role="form" action="{{route('vne.banner.banner.add')}}" method="post" enctype="multipart/form-data" id="form-add-banner">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                <div class="row">
                    <div class="col-sm-6">
                        <label>{{trans('vne-banner::language.label.name') }} <span style="color: red">(*)</span></label>
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="{{trans('vne-banner::language.placeholder.banner.name') }}">
                        </div>
                        <label>{{trans('vne-banner::language.label.desc') }}</label>
                        <div class="form-group">
                            <textarea name="desc" class="form-control" placeholder="{{trans('vne-banner::language.placeholder.banner.desc') }}"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="number" name="priority" min="0" class="form-control" placeholder="{{trans('vne-banner::language.placeholder.banner.priority') }}">
                        </div>
                        <div class="form-group col-xs-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-success">{{ trans('vne-banner::language.buttons.create') }}</button>
                    ...
                    <div class="col-sm-6">
                        <label>{{trans('vne-banner::language.placeholder.banner.close_at') }}</label>
                         <div class="form-group">
                            {{-- <input type="button" class="form-control" name="close_at" id="close_at" placeholder="{{trans('vne-banner::language.placeholder.banner.close_at') }}"> --}}
                            <div class='input-group date'>
                                <input type='text' class="form-control" name="close_at" id="close_at" placeholder="{{trans('vne-banner::language.placeholder.banner.close_at') }}"/>
                        ...
                        <div class="form-group">
                            <input type="text" name="link" class="form-control" placeholder="{{trans('vne-banner::language.placeholder.banner.link') }}">
                        </div>
