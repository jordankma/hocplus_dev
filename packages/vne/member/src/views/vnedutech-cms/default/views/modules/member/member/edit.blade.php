    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form action="{{ route('vne.member.member.update') }}" method="POST" class="bf" id="form-update-member">
                    ...
                    <div class="tab-pane active" id="info-required">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline"><input type="radio" name="gender" @if($member->gender == 'male') checked @endif value="male" >Nam</label>
                                    <label class="radio-inline"><input type="radio" name="gender" @if($member->gender == 'female') checked @endif value="female">Nữ</label>
                                </div>
                                <label>{{ trans('vne-member::language.label.member.user_name') }}</label>
                                <div class="form-group {{ $errors->first('user_name', 'has-error') }}">
                                    <div class="form-group">
                                        <input type="text" name="user_name" value="{{ $member->user_name }}" class="form-control" disabled placeholder="{{trans('vne-member::language.placeholder.member.user_name')}}">
                                    </div>  
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group {{ $errors->first('phone', 'has-error') }}">
                                    <div class="form-group">
                                        <input type="text" name="phone" value="{{ $member->phone }}" disabled class="form-control" placeholder="{{trans('vne-member::language.placeholder.member.phone')}}">
                                    </div>  
                                ...
                                <div class="form-group {{ $errors->first('email', 'has-error') }}">
                                    <div class="form-group">
                                        <input type="text" name="email" value="{{ $member->email }}" disabled class="form-control" placeholder="{{trans('vne-member::language.placeholder.member.email')}}">
                                    </div>  
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="avatar" id="thumbnail1" value="{{ $member->avatar }}" class="form-control">
                                    </div>
                                    <img id="holder1" src="{{ $member->avatar }}" style="margin-top:15px;max-height:100px;">
                                </div>   
                            </div>
                            <!-- /.col-sm-8 -->
                            <div class="col-sm-12">
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{!! route('vne.member.member.manage') !!}"  class="btn btn-danger">{{ trans('vne-member::language.buttons.discard') }}</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.col-sm-4 -->
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group {{ $errors->first('facebook', 'has-error') }}">
                                    <div class="form-group">
                                        <input type="text" name="facebook" value="{{ $member->facebook }}" class="form-control" placeholder="{{trans('vne-member::language.placeholder.member.facebook')}}">
                                    </div>  
                                ...
                                <div class="form-group {{ $errors->first('intro', 'has-error') }}">
                                    <div class="form-group">
                                        <textarea name="intro" class="form-control" rows="5">{{ $member->intro }}</textarea>
                                    </div>  
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class='input-group date'>
                                        <input type='text' class="form-control" name="birthday" value="{{ $member->birthday }}" id="birthday" placeholder="{{trans('vne-member::language.placeholder.member.birthday') }}"/>
                                ...
                                <div class="form-group {{ $errors->first('address', 'has-error') }}">
                                    <div class="form-group">
                                        <textarea name="address" class="form-control" rows="5">{{ $member->address }}</textarea>
                                    </div>  
...
@section('footer_scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#form-update-member').bootstrapValidator({
                feedbackIcons: {
