...
{{-- Page title --}}
@section('title'){{ $title = 'Quản lý tài khoản fullvip' }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        @if ($USER_LOGGED->canAccess('vne.member.member.create.fullvip'))
                            <a href="{{ route('vne.member.member.create.fullvip') }}" class="btn btn-sm btn-default">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="table">
                            ...
                            <tr class="filters">
                                ...
                                <th style="width: 120px">{{ trans('vne-member::language.table.created_at') }}</th>
                                <th style="width: 120px">{{ trans('vne-member::language.table.updated_at') }}</th>
                                <th>{{ trans('vne-member::language.table.action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.member.member.data.fullvip') }}',
                columns: [
