                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group {{ $errors->first('phone', 'has-error') }}">
                            <div class="form-group">
                                <input type="text" name="phone" value="{{ $teacher->phone }}" class="form-control" placeholder="{{trans('vne-teacher::language.placeholder.teacher.phone')}}">
                            </div>  
                        ...
                        <div class="form-group {{ $errors->first('email', 'has-error') }}">
                            <div class="form-group">
                                <input type="text" name="email" value="{{ $teacher->email }}" class="form-control" placeholder="{{trans('vne-teacher::language.placeholder.teacher.email')}}">
                            </div>  
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" name="avatar" value="{{ $teacher->avatar }}" id="thumbnail1" class="form-control">
                            </div>
                            <img id="holder1" src="{{ $teacher->avatar }}" style="margin-top:15px;max-height:100px;">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" name="video_intro" value="{{ $teacher->video_intro }}" id="thumbnail2" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
