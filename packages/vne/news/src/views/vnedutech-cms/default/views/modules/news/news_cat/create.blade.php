...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-news::language.titles.news_cat.add') }} @stop
{{-- page styles --}}
...
@section('content')
    ...
    <section class="content paddingleft_right15">
            <div class="the-box no-border">
                <div class="row">
                        <form action="{{route('vne.news.cat.add')}}" method="post" id="form-add-cat">
                            <div class="col-md-5" style="">
                                <div class="form-group ui-draggable-handle" style="position: static;">
                                    <label for="input-text-1">{{trans('vne-news::language.label_cat.name_category')}}</label>
                                    <input type="text" name="name" class="form-control" id="input-text-1" placeholder="{{trans('vne-news::language.form_cat.category_placeholder')}}">
                                </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <a href="{{route('vne.news.cat.manager')}}" class="btn btn-danger">{{trans('vne-news::language.buttons.discard')}}</a>
                            </div>
                        </form>
                </div>
            </div>
