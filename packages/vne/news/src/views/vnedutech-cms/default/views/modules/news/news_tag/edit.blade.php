...
@section('content')
    ...
    <section class="content paddingleft_right15">
            <div class="the-box no-border">
                <div class="row">
                        <form action="{{route('vne.news.tag.update')}}" method="post" id="form-add-tag">
                            ...
                            <div class="col-md-5" style="">
                                <div class="form-group ui-draggable-handle" style="position: static;">
                                    ...
                                    <input type="text" name="name" value="{{$news_tag->name}}" class="form-control" id="input-text-1" placeholder="{{trans('vne-news::language.form.tags_placeholder')}}">
                                </div>
                            </div>
