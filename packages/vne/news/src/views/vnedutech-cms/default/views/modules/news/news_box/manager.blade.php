...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-news::language.titles.news_box.list') }} @stop
{{-- page styles --}}
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                            @if ($USER_LOGGED->canAccess('vne.news.box.create'))
                                <a href="{{ route('vne.news.box.create') }}" class="btn btn-sm btn-default"><span
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('vne.news.box.data') }}',
                columns: [
                    { data: 'DT_Row_Index', name: 'news_box_id' },
                    { data: 'name', name: 'name' },
