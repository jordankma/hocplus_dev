...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-news::language.titles.news_cat.list') }} @stop
{{-- page styles --}}
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                            @if ($USER_LOGGED->canAccess('vne.news.cat.create'))
                                <a href="{{ route('vne.news.cat.create') }}" class="btn btn-sm btn-default"><span
                            ...
                            <table class="table table-bordered" id="table">
                                <thead>
                                    <tr>                                             
                                        ...
                                        {{-- <th style="width: 120px">{{ trans('vne-news::language.table.list_news_cat.title_cat_paren') }}</th> --}}
