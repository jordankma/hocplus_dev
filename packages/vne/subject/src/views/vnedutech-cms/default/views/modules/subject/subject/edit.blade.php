...
{{-- Page title --}}
@section('title'){{ $title = trans('vne-subject::language.titles.subject.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form action="{{ route('vne.subject.subject.update') }}" method="post" class="bf" id="form-add-subject">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" value="{{$subject->name}}" class="form-control" placeholder="{{trans('vne-subject::language.placeholder.subject.name')}}">
                            </div>
                            <label>{{trans('vne-subject::language.label.subject.background_color')}}<span style="color: red">(*)</span></label>
                            <div class="form-group">
                                <input id="mycp1" type="text" name="background_color" value="{{$subject->background_color}}" class="form-control colorpicker-element" placeholder="{{trans('vne-subject::language.placeholder.subject.background_color')}}">
                            </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="number" min="0" name="priority" value="{{$subject->priority}}" class="form-control" placeholder="{{trans('vne-subject::language.placeholder.subject.priority')}}">
                            </div>
                            <label>{{trans('vne-subject::language.label.subject.background_color_mobile')}}<span style="color: red">(*)</span></label>
                            <div class="form-group">
                                <input id="mycp2" type="text" name="background_color_mobile" value="{{$subject->background_color_mobile}}" class="form-control" placeholder="{{trans('vne-subject::language.placeholder.subject.background_color_mobile')}}" autofocus="">
                            </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group col-xs-12">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success">{{ trans('vne-subject::language.buttons.update') }}</button>
