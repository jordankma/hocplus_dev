...
class RenameController extends LfmController
{
    ...
    {
        $old_name = self::toURLFriendly(request('file'));
        $new_name = self::toURLFriendly(request('new_name'));


        $old_name = parent::translateFromUtf8($old_name);
        $new_name = parent::translateFromUtf8($new_name);
